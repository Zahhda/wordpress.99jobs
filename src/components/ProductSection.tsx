...
const ProductSection = () => {
  ...
  return (
    <section id="product" className="py-16 md:py-24 bg-muted">
          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
            <div className="bg-primary p-4 md:p-6 text-center">
              <div className="flex items-center justify-center gap-3">
                <span className="text-primary-foreground/50 line-through text-xl md:text-2xl font-medium">₹999</span>
                <span className="font-heading text-4xl sm:text-5xl md:text-6xl font-extrabold text-primary-foreground">₹99</span>
              </div>
            ...
            <div className="p-5 md:p-8">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex w-full md:w-auto justify-center items-center gap-2 bg-whatsapp text-primary-foreground font-bold text-lg px-6 py-3 md:px-10 md:py-4 rounded-xl hover:opacity-90 transition-all shadow-lg text-center"
                >
                ...
                <p className="text-xs text-muted-foreground text-center">Payment via WhatsApp UPI • Instant delivery</p>
              </div>
            </div>
          </div>
        </div>
